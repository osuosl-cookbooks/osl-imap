...
describe 'osl-imap-test::auth_ldap' do
  ...
  ALL_PLATFORMS.each do |p|
    context "#{p[:platform]} #{p[:version]}" do
      ...
      it do
        is_expected.to create_template('/etc/dovecot/dovecot-ldap.conf.ext').with(
          cookbook: 'osl-imap',
          mode: '0640',
          group: 'dovecot',
          sensitive: true,
      ...
      it do
        is_expected.to render_file('/etc/dovecot/dovecot-ldap.conf.ext').with_content(
          <<~EOF
            # This file was generated by Chef Infra
            # Do NOT modify this file by hand.
      ...
      it { expect(chef_run.template('/etc/dovecot/dovecot-ldap.conf.ext')).to notify('service[dovecot]').to(:reload) }
